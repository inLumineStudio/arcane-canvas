...
- **Secret page "The Watcher" (2026-09-25):** the monitor sequence 1 1 4 2 3 1 now opens `/orison/the-watcher` instead of the 404: rings of pixel eyes opening and turning around the great ORISON eye, all following the visitor; standing still makes every eye blink at once while the dark closes in; a short transmission is typed out with corrupted glyphs; "Close your eyes" leads back. Inside the CRT, without header/footer (`PageShell bare`), noindex. **The eight lines are the agency's proposal: Marco should approve or rewrite them** (`orison.watcher` in en.ts). The power-button glitch now stays inside the monitor glass.
